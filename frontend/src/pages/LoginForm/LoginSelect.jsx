...
// export default function LoginSelect(){ const nav = useNavigate();
//   return (
//     <div className="min-h-screen flex items-center justify-center">
//       <div className="p-8 border rounded">
//         <h2 className="text-xl font-bold mb-4">Login as</h2>
//         <div className="flex gap-4">
//           <button className="px-4 py-2 border" onClick={()=>nav('/login?role=client')}>Client</button>
//           <button className="px-4 py-2 border" onClick={()=>nav('/login?role=freelancer')}>Freelancer</button>
//         </div>
//       </div>
//     </div>
//   )
  ...
  return (
    <Container>
      ...
      <CardContainer>
        ...
        {/* Client Card */}
        <Card onClick={() => navigate("/login?role=client")}>
          <Briefcase size={50} className="icon" />
          <h4>I’m Client</h4>
          <p>Looking For Pros To Turn Your Ideas Into Reality.</p>
        </Card>

        {/* Freelancer Card */}
        <Card onClick={() => navigate("/login?role=freelancer")}>
      ...
      <LoginText>
        New Here?{" "}
        <span className="login-link" onClick={() => navigate("/roleselect")}>
          Sign Up
        </span>
        : Start Your Journey.
      </LoginText>
