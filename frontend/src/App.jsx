...
<Route path="/redirect/:uid" element={<RedirectHandler/>} />
 ...
 <Route path="/freelancer/:uid" element={<FreelancerPage/>} />
...
<Route path="/freelancer/:uid/job/:jobid" element={<FreelancerPage/>} />
 ...
 <Route path="/chat/:freelancerId" element={<ChatPage />} />
  ...
  <Route path="/messages" element={ <ChatListScreen currentUid={auth.currentUser?.uid}
      onOpenChat={(chatId, withUid, name, image) =>
        navigate(`/chat/${chatId}`, {
          state: { chatId, withUid, name, image },
        })
      }/>}
      />
...
<Route
  ...
  element={
    <Requestchatscreen
      ...
      otherUid={location.state?.otherUid}
      otherName={location.state?.otherName}
      otherImage={location.state?.otherImage}
...
<Route
  ...
  element={
    <RequestChatListScreen
      currentUid={auth.currentUser?.uid}
      openRequestChat={(chatId, otherUid, name, image) =>
