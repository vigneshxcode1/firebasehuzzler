...
import "../ClientRegister/OtpVerify.css"; // same UI file

const FreelancerOtpVerify = () => {
  ...
  const verifyOtp = async () => {
    ...
    try {
      ...
      // Get freelancer role from Firestore
      ...
      if (data.role !== "freelancer") {
        alert("This OTP is not for a freelancer account.");
        return;
      }

      // Delete temp local data
...
export default FreelancerOtpVerify;
