...
//     <div id="fh-p" className="fh-page rubi" style={{marginLeft:"-10px"}} >
...
//             <div>
//               <h2 style={{ margin: 0, fontSize: 24, fontWeight: 700 }}>{fullName}</h2>
...
//     onClick={() => setActiveTab("works")}
//     style={{
//       padding: "8px 16px",      // 🔥 small background
//       borderRadius: 999,
//       border: "none",
//       cursor: "pointer",
//       fontSize: 14,
        ...
        <div style={{ background: "#F6F6F6", minHeight: "100vh", paddingBottom: 40, }}>
          ...
          >
            ...
            <div style={{
              ...
              <p style={{ opacity: "70%", fontSize: "16px" }}>abc@gmail.com</p>
              <div style={styles.linksRow}>
                {profile.behance && (
                  <a href={profile.behance} target="_blank" rel="noopener noreferrer" style={styles.link}>
                    Behance
