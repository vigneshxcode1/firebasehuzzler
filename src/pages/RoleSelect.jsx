...
//       <LoginText>
//         Already Here?{" "}
//         <span className="login-link" onClick={() => nav("/")}>
//           Log In
//         </span>
  ...
  return (
    <Container>
      ...
      <CardContainer>
        ...
        {/* Client Card */}
        <Card onClick={() => nav("/client-register")}> {/* ✅ direct route */}
          <Briefcase size={50} className="icon" />
          <h4>I’m Client</h4>
          <p>
            Looking For Pros To Turn Your Ideas Into Reality? We’ve Got You Covered.
          </p>
        </Card>
      </CardContainer>
