...
// //       savedJobs: arrayUnion(id),   // Save this job's ID
// //     });
...
// //         <button className="btn btn-fav" onClick={handleFavorite}>Save</button>
// //       </div>
// //     </div>
// //   );
// // }
...
// //           <img src={share} alt="share" width={18} style={{ cursor: "pointer" }} onClick={handleShare} />style={{ cursor: "pointer" }}
...
// //           <div className="name">{job.clientName || "Helen Angle"}</div>
// //           <div className="role">UIUX Designer</div>
// //         </div>
// //       </div>
...
// //         <div className="icon-meta">🕒 5 days ago</div>
// //       </div>

// //       {/* MONEY */}
// //       <div className="money-box">
// //         <div>
// //           <div className="range">₹{job.price || 1000} – ₹6000</div>
// //           <div className="sub-text">Timeline: {job.timeline || "2 - 3 weeks"}</div>
...
// //           .map((s, i) => <div key={i} className="skill-chip">{s}</div>)}
// //       </div>
