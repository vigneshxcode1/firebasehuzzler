...
const FreelancerProfile = () => {
  ...
  const addPortfolio = async () => {
    const payload = {
      ...
      Upload_ProjectURL: modalData.Upload_ProjectURL
        .split(",")
        .map((url) => url.trim())
        .filter((url) => url),
    };
  ...
  return (
    <div className="profile-page">
      ...
      <div className="profile-form">
        ...
        {!currentProfileId ? (
          <button className="btn create" onClick={createProfile}>
            Create Profile
          </button>
        ) : (
      ...
      {showModal && (
        <div className="modal">
          <div className="modal-content">
            ...
            <button
              className="btn save"
              onClick={editingPortfolioId ? updatePortfolio : addPortfolio}
            >
