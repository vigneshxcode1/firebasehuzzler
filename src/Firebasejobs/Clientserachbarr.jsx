...
//             <h1 className="fh-title">
//               Welcome,
//               <div>Pixel Studios Pvt Ltd123</div>
//             </h1>
...
//  <div className="fh-header-right">
//  <img src={message} style={{width:"31px", height:"29px", cursor:"pointer"}} alt=""  onClick={() => navigate("/client-dashbroad2/messages")} />


//  {/* ------------------ NOTIFICATION BUTTON ------------------ */}
//  <div  onClick={() => setNotifOpen(true)}>
//  <img src={notification} style={{width:"31px", height:"29px", cursor:"pointer"}} alt=""  />
//  {pending > 0 && (
//  <span
//  style={{
//  position: "absolute",
