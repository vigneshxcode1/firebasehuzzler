...
//     if (!firstName.trim())
//       return show("Enter First Name");
//     if (!lastName.trim())
//       return show("Enter Last Name");
//     if (!email.trim())
//       return show("Enter Email");
...
//     try {
//       // 1️⃣ Check duplicates in Firestore
...
//           return show("This email is registered as a Freelancer. Use another email.");
//         }
//         return show("Email already registered, please login.");
//       }

//       // 2️⃣ Send OTP request to backend
...
//       show(err.response?.data?.message || "Error sending OTP");
//     } finally {
//       setLoading(false);
//     }
//   };
