...
export default function CompanyProfileView() {
  ...
  return (
    <div style={{ backgroundColor: "#fff", minHeight: "100vh", fontFamily: "Rubik" }}>
      
      {/* HEADER */}
      <div
        style={{
          height: 240,
          // background: "linear-gradient(180deg, #FFFDD0, #FFFA9E)",
      ...
      {/* CONTENT */}
      <div style={{ padding: 20, fontFamily: "Rubik" }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            >
              ...
              <p style={{ fontSize: 14, color: "#333" }}>
                {data.business_description ||
                  "Skilled Video Editor with 5+ years of experience in Adobe Premiere Pro, After Effects, and DaVinci Resolve. Specializes in storytelling through visuals."}
              </p>
            </div>
            ...
            >
              ...
              <p style={{ fontSize: 14, marginBottom: 6 }}>
                <strong>Company size:</strong> {data.team_size || "25–30 employees"}
              </p>

              <p style={{ fontSize: 14, marginBottom: 6 }}>
                <strong>Account Handler:</strong> {data.account_handler || "Rithik S"}
              </p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            >
              <h3 style={{ marginBottom: 12 }}>Tools</h3>
