...
//   const renderEmptyState = (title, subtitle, onClick, buttonText) => (
//     <div style={styles.emptyStateWrapper}>
//       <div style={styles.emptyImagePlaceholder} />
//       <div style={styles.emptyTitle}>{title}</div>
//       {subtitle && <div style={{ color: "#6B7280", marginTop: 6, maxWidth: 420 }}>{subtitle}</div>}
//       {onClick && (
//         <button style={{ marginTop: 16, padding: "10px 18px", borderRadius: 20, border: "none", background: "#FDFD96", fontWeight: 700, cursor: "pointer" }} onClick={onClick}>
//           {buttonText || "Add"}
//         </button>
//       )}
//     </div>
...
//   // ---------------- MAIN RENDER (ServiceScreenOne-style layout) ----------------
//   const isWorksTab = selectedTab === "Works";
//   const is24hTab = selectedTab === "24 hour" || selectedTab === "24h" || selectedTab === "24 Hours";
...
export default function AddJobScreen() {
  ...
  return (
    <div
      ...
      style={{
        marginLeft: collapsed ? "-510px" : "-60px",
